...
CREATE TABLE `etiquetas` (
  ...
  `etiq_leitura` smallint(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`etiq_id`),
...
CREATE TABLE `leitura` (
  ...
  `leit_quem_cpf` varchar(50) NOT NULL,
  PRIMARY KEY (`leit_id`),
...
INSERT INTO `usuario` VALUES (1,'teste','email@email.com','8cb2237d0679ca88db6464eac60da96345513964','Admin','Ativo','0');
...
-- Dump completed on 2016-03-30 14:53:48
