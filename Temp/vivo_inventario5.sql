...
CREATE TABLE `deposito` (
  ...
  `depo_logradouro` text CHARACTER SET latin1 COMMENT '{"user-control":"text"}',
  ...
  `depo_observacao` text CHARACTER SET latin1 COMMENT '{"user-control":"text"}',
...
INSERT INTO `deposito` VALUES (588,'empresa',0,'regiao','tipo_logradouro','logradouro','numero','bairro','complemento','cidade','cep','Ativo','livre1',NULL,NULL,'observacao',1,0);
...
CREATE TABLE `materiais` (
  ...
  `mate_nome` text COLLATE utf8_unicode_ci NOT NULL COMMENT '{"user-control":"text"}',
  `mate_unidade_medida` text CHARACTER SET latin1 NOT NULL COMMENT '{"user-control":"text"}',
...
INSERT INTO `materiais` VALUES (3,'codigo','nome','unidade_medida','valor_unitario','livre1','livre2','livre3','observacao',0);
...
-- Dump completed on 2016-03-24 13:00:17
