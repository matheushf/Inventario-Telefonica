...
//        echo $sql;
    ...
    function QuantidadePorCentro($depo_centro) {
        global $db;

        $sql = "SELECT DISTINCT etiq_mate_material FROM etiquetas WHERE etiq_depo_centro = (SELECT depo_id FROM deposito WHERE depo_centro = {$depo_centro})";
