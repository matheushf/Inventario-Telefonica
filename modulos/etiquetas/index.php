...
<fieldset class="scheduler-border" style="margin-top: 20px">
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <button class="btn btn-primary" id="btn-leitura">Leitura</button>
        ...
        <table class="table table-striped table-hover table-bordered table-responsive">
            ...
            foreach ($EtiquetasLista as $etiquetas) {
                ...
                <tr>
                    <td>
                        <center>
                            <input type="checkbox" id="<?php echo $etiquetas->etiq_id ?>"
                                   value="<?php echo $etiquetas->etiq_id ?>">
                        </center>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <input type="hidden" value="<?php echo $etiquetas->mate_unidade_medida ?>"
